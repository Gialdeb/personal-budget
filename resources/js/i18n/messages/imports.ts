    ...
    it: {
        ...
        index: {
            ...
            placeholders: {
                ...
                sourceAccount: 'Seleziona il conto da importare',
            ...
            helpers: {
                ...
                sourceAccount:
                    'Le righe lette verranno associate a {account} quando il file non contiene una colonna conto.',
            },
            actions: {
                upload: 'Carica importazione',
                uploading: 'Caricamento in corso...',
                openDetail: 'Apri dettaglio',
                archiveImport: 'Archivia',
                restoreImport: 'Ripristina',
    ...
    en: {
        ...
        index: {
            ...
            placeholders: {
                ...
                sourceAccount: 'Select the account to import',
            ...
            helpers: {
                ...
                sourceAccount:
                    'Read rows will be assigned to {account} when the file has no account column.',
            },
            actions: {
                upload: 'Upload import',
                uploading: 'Uploading...',
                openDetail: 'Open detail',
                archiveImport: 'Archive',
                restoreImport: 'Restore',

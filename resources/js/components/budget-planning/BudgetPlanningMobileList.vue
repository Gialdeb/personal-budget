...
function sectionTone(sectionKey: string): string {
    ...
    }[sectionKey] ?? 'border-white/70 bg-white/85 dark:border-white/10 dark:bg-slate-950/70';
}
</script>
...
<template>
    <div class="space-y-5 lg:hidden">
        <Card
            ...
            "
        >
            <CardHeader class="border-b border-slate-200/70 bg-slate-50/90 dark:border-white/10 dark:bg-slate-900/70">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <CardTitle class="text-base font-semibold text-slate-950 dark:text-white">
                            {{ section.label }}
                        </CardTitle>
                    ...
                    <div class="rounded-full bg-slate-950 px-3 py-1.5 text-xs font-semibold text-white dark:bg-white dark:text-slate-950">
            ...
            <CardContent class="space-y-4 p-4">
                <div class="grid grid-cols-2 gap-2 rounded-2xl bg-slate-50 p-3 dark:bg-slate-900">
                    <div

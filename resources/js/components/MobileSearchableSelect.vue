...
function openSheet(): void {
    if (props.disabled || !isMobile.value) {
        return;
    }
...
<template>
    <SearchableSelect
        ...
        @create-option="emit('create-option', $event)"
    />
    ...
    <div v-else class="relative">
        ...
        <Sheet :open="open" :modal="false" @update:open="open = $event">
            ...
            >
                ...
                <div class="mt-5 flex min-h-0 flex-1 flex-col space-y-3">
                    <div class="relative">
                        <Search
                    ...
                    <div
                        ...
                        class="min-h-0 flex-1 overflow-y-auto overscroll-contain rounded-[1.5rem] border border-slate-200/80 bg-slate-50/85 p-2 dark:border-white/10 dark:bg-slate-950/60"
                    >
                        <div
                            v-if="
                                supportsHierarchy &&

        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="grid gap-3 lg:grid-cols-3">
                <div>
                    ...
                    <Select :model-value="pipeline" @update:model-value="emit('update:pipeline', String($event))">
                        <SelectTrigger class="h-11 rounded-2xl border-slate-200 dark:border-slate-800">
                            <SelectValue :placeholder="t('admin.automation.filters.pipelinePlaceholder')" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem
                ...
                <div>
                    ...
                    <Select :model-value="status" @update:model-value="emit('update:status', String($event))">
                        <SelectTrigger class="h-11 rounded-2xl border-slate-200 dark:border-slate-800">
                            <SelectValue :placeholder="t('admin.automation.filters.statusPlaceholder')" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem
                ...
                <div>
                    ...
                    <Select
                        ...
                        @update:model-value="emit('update:triggerType', String($event))"
                    >
                        <SelectTrigger class="h-11 rounded-2xl border-slate-200 dark:border-slate-800">
                            <SelectValue :placeholder="t('admin.automation.filters.triggerPlaceholder')" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem

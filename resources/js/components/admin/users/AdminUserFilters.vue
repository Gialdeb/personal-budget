...
<template>
    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <div class="grid gap-3 xl:grid-cols-[minmax(0,1.6fr)_repeat(3,minmax(0,1fr))]">
                <div class="relative">
                ...
                <div>
                    ...
                    <Select :model-value="role" @update:model-value="emit('update:role', String($event))">
                ...
                <div>
                    ...
                    <Select :model-value="plan" @update:model-value="emit('update:plan', String($event))">
                        <SelectTrigger class="h-11 rounded-2xl border-slate-200 dark:border-slate-800">
                            <SelectValue :placeholder="t('admin.users.filters.planPlaceholder')" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem

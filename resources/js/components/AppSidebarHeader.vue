...
<template>
    <header class="shrink-0 px-4 pt-4 md:px-6 md:pt-6">
        <div class="md:hidden">
            <div
                class="flex items-center justify-between rounded-[1.75rem] border border-slate-200/80 bg-white/96 px-4 py-3 shadow-[0_22px_48px_-34px_rgba(15,23,42,0.42)] backdrop-blur dark:border-slate-800 dark:bg-slate-950/92"
            >
                <SidebarTrigger
                    class="rounded-2xl border border-slate-200/80 bg-white/90 shadow-sm transition hover:bg-white dark:border-slate-800 dark:bg-slate-950/80 dark:hover:bg-slate-900"
                />
                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    :class="
                                        notificationSurfaceClass(notification)
                                    "
                                >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {{
                                                t(
                                                    'app.shell.notifications.viewAll',
                                                )
                                            }}
                                        </Link>
                                    </div>

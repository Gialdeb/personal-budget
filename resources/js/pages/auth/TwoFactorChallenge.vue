...
const authConfigContent = computed<TwoFactorConfigContent>(() => {
    if (showRecoveryInput.value) {
        return {
            ...
            buttonText: t('auth.twoFactor.recoveryCode.switchAction'),
        };
    }

    return {
        title: t('auth.twoFactor.authenticationCode.title'),
        description: t('auth.twoFactor.authenticationCode.description'),
        buttonText: t('auth.twoFactor.authenticationCode.switchAction'),
    };
});

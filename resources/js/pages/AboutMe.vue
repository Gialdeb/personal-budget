    ...
    <PublicMarketingLayout>
        ...
        <div class="min-h-screen bg-[#fffdfb] text-slate-950">
            ...
            <main class="pb-14 sm:pb-18">
                ...
                <div
                    class="mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 sm:gap-16 sm:px-6 lg:gap-18 lg:px-8"
                >
                    <PublicPageSection
                            ...
                            >
                                ...
                                >
                                    <div>
                                        ...
                                        <p
                                            class="mt-2 text-sm leading-7 break-all text-slate-600 sm:break-normal"
                                        >
                                            {{ publicProfileLinks.website }}
                                        </p>
                                    </div>

                        ...
                        <div class="max-w-3xl space-y-9">
                            ...
                            >
                                <Link
                                    ...
                                    @click="
                                        trackRegisterClick('home_hero_primary')
                                    "
                                >
                                    {{
                                        $page.props.auth.user
                                ...
                                >
                                    {{
                                        t(
                                            'auth.welcome.actions.discoverFeatures',
                                        )
                                    }}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {{
                                            t(
                                                'auth.welcome.preview.banner.title',
                                            )
                                        }}
                                    </div>
                                    <p
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            >
                                ...
                                >
                                    {{
                                        t(
                                            'auth.welcome.pricing.items.recurring',
                                        )
                                    }}
                                </h3>
                                <p
                            ...
                            >
                                ...
                                <div class="flex flex-col gap-3 sm:flex-row">
                                    ...
                                    >
                                        {{
                                            t(
                                                'auth.welcome.actions.viewPricing',
                                            )
                                        }}
                                    </Link>
                                </div>

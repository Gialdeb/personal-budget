...
class UpsertKnowledgeSectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $knowledgeSection = $this->route('knowledgeSection');
        ...
        return [
            'slug' => [
                ...
                'max:120',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('knowledge_sections', 'slug')
                    ->ignore($knowledgeSection instanceof KnowledgeSection ? $knowledgeSection->getKey() : null),
            ],

...
class CommunicationOutboundDetailResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'template' => $this->resource->template ? [
                ...
                'channel' => $this->resource->template->channel?->value,
            ] : null,
            'recipient' => $recipient ? [
            ...
            'creator' => $creator ? [
                'uuid' => $creator->uuid,
                'label' => trim(implode(' ', array_filter([$creator->name, $creator->surname]))) ?: $creator->email,
                'email' => $creator->email,
            ] : null,
            'content' => [
            ...
            'payload_snapshot' => $this->resource->payload_snapshot,
        ];
    }
}

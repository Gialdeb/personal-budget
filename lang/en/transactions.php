...
return [
    ...
    'flash' => [
        ...
        'recurring_deleted' => 'Plan and linked transactions permanently deleted.',
        'recurring_occurrence_amount_updated' => 'Recurring occurrence amount updated successfully.',
        'recurring_occurrence_updated' => 'Recurring occurrence updated successfully.',
    ...
    'validation' => [
        ...
        'recurring_reminders_invalid' => 'Select valid reminders for this recurring entry.',
        'recurring_reminders_max' => 'You may set up to three reminders for each recurring entry.',
        'recurring_reminders_range' => 'Each reminder must be between 1 and 15 days in advance.',
        'recurring_reminders_distinct' => 'The same advance reminder cannot be selected twice.',
        'recurring_variable_amount_only_recurring' => 'Variable amounts can only be enabled for recurring plans, not installment plans.',
        'recurring_occurrence_amount_required' => 'Enter the actual amount for this recurring occurrence.',
        'recurring_occurrence_amount_invalid' => 'The actual amount must be a valid number.',
        'recurring_occurrence_amount_positive' => 'The actual amount must be greater than zero.',
        'recurring_occurrence_amount_too_large' => 'The actual amount exceeds the allowed limit.',
        'recurring_occurrence_amount_decimals' => 'The actual amount may have at most two decimal places.',
        'recurring_occurrence_amount_fixed' => 'This recurring amount is fixed and cannot be changed from a single occurrence.',
        'recurring_occurrence_amount_matched' => 'The amount cannot be changed because this occurrence is matched to an existing transaction.',
        'recurring_occurrence_amount_locked' => 'This occurrence no longer allows its amount to be changed.',
        'recurring_occurrence_amount_transaction_unavailable' => 'The linked generated transaction is not available for updating.',
        'recurring_occurrence_amount_refunded' => 'The amount cannot be changed after the linked transaction has been refunded.',
        'recurring_occurrence_locked' => 'This occurrence no longer allows its date or account to be changed.',
        'recurring_transaction_update_from_plan' => 'Transactions generated by a recurring plan must be updated from their occurrence in the plan.',
